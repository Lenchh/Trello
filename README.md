...
This is my educational pet project, which is a simplified clone of the popular Trello service - (https://trello.com/uk).  Trello is a visual tool for managing projects and tasks using the Kanban system. It helps organize workflows using boards, lists, and cards, providing a clear view of task progress.
